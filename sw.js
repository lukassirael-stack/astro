...
const CACHE = 'kairos-v298';
const SHELL = ['./', './index.html', './styles.css?v=298', './kairos-core.js?v=298', './data.js?v=298', './app.js?v=298', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './tile-mapa.webp?v=5', './tile-prochazis.webp?v=5', './tile-vztahy.webp?v=5', './tile-horoskop.webp?v=5', './tile-cisla.webp?v=5', './tile-cakra.webp?v=5', './tile-navraty.webp?v=5', './tile-hvezdy.webp?v=5', './logo-stars.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day.webp?v=7', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day-hd2.webp?v=1'];
