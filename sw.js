...
const CACHE = 'kairos-v271';
const SHELL = ['./', './index.html', './styles.css?v=271', './kairos-core.js?v=271', './data.js?v=271', './app.js?v=271', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './tile-mapa.webp?v=4', './tile-prochazis.webp?v=4', './tile-vztahy.webp?v=4', './tile-horoskop.webp?v=4', './tile-cisla.webp?v=4', './tile-cakra.webp?v=4', './tile-navraty.webp?v=4', './tile-hvezdy.webp?v=4', './logo-stars.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day.webp?v=7', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day-hd2.webp?v=1'];
