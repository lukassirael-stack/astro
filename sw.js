...
const CACHE = 'kairos-v233';
const SHELL = ['./', './index.html', './styles.css?v=233', './kairos-core.js?v=233', './data.js?v=233', './app.js?v=233', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './logo-stars.webp?v=1', './logo-emblem-day.webp?v=1', './logo-stars-day.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day3.webp?v=1', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day3-hd.webp?v=1'];
