...
const CACHE = 'kairos-v350';
const SHELL = ['./', './index.html', './styles.css?v=350', './kairos-core.js?v=350', './data.js?v=350', './app.js?v=350', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './cat-vse.webp?v=1', './cat-portal.webp?v=1', './cat-osobni.webp?v=1', './cat-priroda.webp?v=1', './cat-zatmeni.webp?v=1', './cat-luna.webp?v=1', './cat-planety.webp?v=1', './cat-hvezdy.webp?v=1', './cat-roje.webp?v=1', './cat-slunce.webp?v=1', './cat-komety.webp?v=1', './tile-mapa.webp?v=7', './tile-prochazis.webp?v=7', './tile-vztahy.webp?v=7', './tile-horoskop.webp?v=7', './tile-cisla.webp?v=7', './tile-cakra.webp?v=7', './tile-navraty.webp?v=7', './tile-hvezdy.webp?v=7', './logo-stars.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day.webp?v=7', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day-hd2.webp?v=1'];
