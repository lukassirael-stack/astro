...
const CACHE = 'kairos-v232';
const SHELL = ['./', './index.html', './styles.css?v=232', './kairos-core.js?v=232', './data.js?v=232', './app.js?v=232', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './logo-stars.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day2.webp?v=2', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day2-hd.webp?v=2'];
