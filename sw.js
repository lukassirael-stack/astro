...
const CACHE = 'kairos-v264';
const SHELL = ['./', './index.html', './styles.css?v=264', './kairos-core.js?v=264', './data.js?v=264', './app.js?v=264', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './tile-mapa.webp?v=1', './tile-prochazis.webp?v=1', './tile-vztahy.webp?v=1', './tile-horoskop.webp?v=1', './tile-cisla.webp?v=1', './tile-cakra.webp?v=1', './tile-navraty.webp?v=1', './tile-hvezdy.webp?v=1', './tile-efemeridy.webp?v=1', './logo-stars.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day.webp?v=7', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day-hd2.webp?v=1'];
