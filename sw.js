...
const CACHE = 'kairos-v364';
const SHELL = ['./', './index.html', './styles.css?v=364', './kairos-core.js?v=364', './data.js?v=364', './app.js?v=364', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './cat-vse.webp?v=2', './cat-portal.webp?v=2', './cat-osobni.webp?v=2', './cat-priroda.webp?v=2', './cat-zatmeni.webp?v=2', './cat-luna.webp?v=2', './cat-planety.webp?v=2', './cat-hvezdy.webp?v=2', './cat-roje.webp?v=2', './cat-slunce.webp?v=2', './cat-komety.webp?v=2', './tile-mapa.webp?v=8', './tile-prochazis.webp?v=8', './tile-vztahy.webp?v=8', './tile-horoskop.webp?v=8', './tile-cisla.webp?v=8', './tile-cakra.webp?v=8', './tile-navraty.webp?v=8', './tile-hvezdy.webp?v=8', './tile-maya.webp?v=8', './tile-cina.webp?v=8', './logo-stars.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day.webp?v=7', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day-hd2.webp?v=1'];
