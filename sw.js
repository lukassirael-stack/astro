...
const CACHE = 'kairos-v366';
const SHELL = ['./', './index.html', './styles.css?v=366', './kairos-core.js?v=366', './data.js?v=366', './app.js?v=366', './astronomy.browser.min.js', './manifest.webmanifest', './logo.png', './logo-emblem.webp?v=1', './cyklus-dne.webp?v=1', './cat-vse.webp?v=2', './cat-portal.webp?v=2', './cat-osobni.webp?v=2', './cat-priroda.webp?v=2', './cat-zatmeni.webp?v=2', './cat-luna.webp?v=2', './cat-planety.webp?v=2', './cat-hvezdy.webp?v=2', './cat-roje.webp?v=2', './cat-slunce.webp?v=2', './cat-komety.webp?v=2', './tile-mapa.webp?v=9', './tile-prochazis.webp?v=9', './tile-vztahy.webp?v=9', './tile-horoskop.webp?v=9', './tile-cisla.webp?v=9', './tile-cakra.webp?v=9', './tile-navraty.webp?v=9', './tile-hvezdy.webp?v=9', './tile-maya.webp?v=9', './tile-cina.webp?v=9', './logo-stars.webp?v=1', './moon-tex.png?v=1', './icon-192.png', './icon-512.png', './icon-maskable-512.png', './sky-day.webp?v=7', './sky-night.webp?v=4', './sky-night-hd2.webp?v=1', './sky-day-hd2.webp?v=1'];
